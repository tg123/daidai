...
export const I18N_DICT: Record<string, LocaleDict> = {};

export function registerLocale(code: string, dict: LocaleDict): void {
    I18N_DICT[code] = dict;
}
 ...
 */
export function pickLang(opts?: PickLangOpts): LocaleCode {
    const o = opts || {};
 ...
 */
export function createT(getLang: () => string): TFunction {
